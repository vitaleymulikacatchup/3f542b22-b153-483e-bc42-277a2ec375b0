...
export const metadata: Metadata = {
  title: "Sweet Artisan - Premium Handcrafted Chocolates",
  description: "Artisan chocolate bakery creating premium handcrafted chocolates with the finest ingredients. Custom orders and gourmet chocolate gifts available.",
  keywords: "artisan chocolate, handcrafted chocolates, premium chocolate, chocolate bakery, custom chocolate orders, gourmet gifts",
  openGraph: {
    title: "Sweet Artisan - Premium Handcrafted Chocolates",
    description: "Artisan chocolate bakery creating premium handcrafted chocolates with the finest ingredients.",
    siteName: "Sweet Artisan",
    images: [
      {
        url: "https://images.pexels.com/photos/30222481/pexels-photo-30222481.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Artisan chocolate bakery workshop"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Sweet Artisan - Premium Handcrafted Chocolates",
    description: "Artisan chocolate bakery creating premium handcrafted chocolates with the finest ingredients.",
    images: ["https://images.pexels.com/photos/30222481/pexels-photo-30222481.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
